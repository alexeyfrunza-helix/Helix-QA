...
Функционал: Изменение баланса бонусного счета

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

Сценарий: Изменение баланса бонусного счета
	...
	И из выпадающего списка с именем 'Тип' я выбираю точное значение "Изменение баланса бонусного счета"
	...
	//Делаем взнос на БС
	Дано Я открываю основную форму документа "ОперацияПоБонусномуСчету"
	И из выпадающего списка с именем 'ВладелецБонусногоСчета' я выбираю по строке "$$Клиент2$$"
	И в поле с именем 'Сумма' я ввожу текст "100,00"
	И я нажимаю на кнопку создать поля с именем 'БонусныйСчет'
	И я нажимаю на кнопку с именем 'КнопкаДополнительно'
	И из выпадающего списка с именем 'ВидБонусногоСчета' я выбираю по строке "$$БС1$$"
	И в поле с именем 'Владелец' я ввожу текст "$$Клиент2$$"
	И из выпадающего списка с именем 'Владелец' я выбираю по строке "$$Клиент2$$"
	И я перехожу к следующему реквизиту
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
	И я нажимаю на кнопку с именем 'ФормаКнопкаПровестиИЗакрыть'
