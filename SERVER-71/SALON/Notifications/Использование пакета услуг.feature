...
Функционал: Использование пакета услуг

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

Сценарий: Использование пакета услуг
	...
	И из выпадающего списка с именем 'Тип' я выбираю точное значение "Использование пакета услуг"
	...
	И Пауза 1
	И в поле с именем 'Наименование' я ввожу текст "Использование пакета"
