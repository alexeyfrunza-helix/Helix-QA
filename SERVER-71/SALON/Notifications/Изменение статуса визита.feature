...
Функционал: Изменение статуса визита

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

Сценарий: Изменение статуса визита
	...
	И из выпадающего списка с именем 'Тип' я выбираю точное значение "Изменение статуса визита"
	...
	И Пауза 1
	И в поле с именем 'Наименование' я ввожу текст "Визит был изменен"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
	//И 1_Добавление сегмента клиентов
	И из выпадающего списка с именем 'СтатусВизита' я выбираю точное значение "Пришел"
 ...
 /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ///Добавить остальные проверки статусов  - (Не пришел, Окончен, Отменен) 
 /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
