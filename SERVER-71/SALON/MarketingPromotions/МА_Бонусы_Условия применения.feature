...
* Создаю бонусный счет клиенту
	Дано Я открываю навигационную ссылку "$$СсылкаКлиента$$"
	И я нажимаю на кнопку с именем 'КнопкаДобавитьБонусныеСчета'
	И в поле с именем 'ВидБонусногоСчета' я ввожу текст "Бонус$$СлучайноеЧисло$$"
	И из выпадающего списка с именем 'ВидБонусногоСчета' я выбираю по строке "Бонус$$СлучайноеЧисло$$"
	И в поле с именем 'ПолеОплатаВводСуммы' я ввожу текст "55,00"
	И я нажимаю на кнопку с именем 'Оплатить'

* Проверка МА
	И Я проверяю маркетинговую акции
	И элемент формы с именем 'НачисленоБонусовИтогСумма' стал равен "55,55"
	И у элемента формы с именем 'НачисленоБонусовИтогСумма' текст редактирования стал равен "55,55"
...
Сценарий: Проверка МА условие - Всегда
	...
	И Я проверяю маркетинговую акции
	И элемент формы с именем 'НачисленоБонусовИтогСумма' стал равен "60,60"
	И у элемента формы с именем 'НачисленоБонусовИтогСумма' текст редактирования стал равен "60,60"
...
* Проверка МА
	И Я проверяю маркетинговую акции
	И элемент формы с именем 'НачисленоБонусовИтогСумма' стал равен "65,65"
	И у элемента формы с именем 'НачисленоБонусовИтогСумма' текст редактирования стал равен "65,65"
...
* Проверка МА
	И Я проверяю маркетинговую акции
	И элемент формы с именем 'НачисленоБонусовИтогСумма' стал равен "70,70"
	И у элемента формы с именем 'НачисленоБонусовИтогСумма' текст редактирования стал равен "70,70"
...
Сценарий: Проверка МА условие - Количество
	И предыдущий сценарий выполнен успешно
	И Я проверяю маркетинговую акции
	И элемент формы с именем 'НачисленоБонусовИтогСумма' стал равен "75,75"
	И у элемента формы с именем 'НачисленоБонусовИтогСумма' текст редактирования стал равен "75,75"
...
Сценарий: Проверка МА условие - Наличие пакета услуг
	И предыдущий сценарий выполнен успешно
	И Я проверяю маркетинговую акции
	И элемент формы с именем 'НачисленоБонусовИтогСумма' стал равен "80,80"
	И у элемента формы с именем 'НачисленоБонусовИтогСумма' текст редактирования стал равен "80,80"

Сценарий: Создание МА условие - Рекомендация клиента (дней после регистрации 1)
	Дано Я открываю навигационную ссылку "$$МА_УсловияПрименения$$"
...
* Проверка МА
	И Я проверяю маркетинговую акции
	И элемент формы с именем 'НачисленоБонусовИтогСумма' стал равен "85,85"
	И у элемента формы с именем 'НачисленоБонусовИтогСумма' текст редактирования стал равен "85,85"
...
Сценарий: Проверка МА условие - Сумма
	И предыдущий сценарий выполнен успешно
	И Я проверяю маркетинговую акции
	И элемент формы с именем 'НачисленоБонусовИтогСумма' стал равен "90,90"
	И у элемента формы с именем 'НачисленоБонусовИтогСумма' текст редактирования стал равен "90,90"
...
Сценарий: Проверка МА условие - Промокод
	...
	И элемент формы с именем 'НачисленоБонусовИтогСумма' стал равен "95,95"
	И у элемента формы с именем 'НачисленоБонусовИтогСумма' текст редактирования стал равен "95,95"

Сценарий: Создание МА условие - Взнос на лицевой счет
	Дано Я открываю навигационную ссылку "$$МА_УсловияПрименения$$"
	И в поле с именем 'Наименование' я ввожу текст "Условие - Взнос на лицевой счет; Способ - Процент 20,20% $$СлучайноеЧисло$$"
	И из выпадающего списка с именем 'УсловиеПредоставленияСкидки' я выбираю точное значение "Взнос на лицевой счет"
...
Сценарий: Проверка МА условие - Взнос на лицевой счет
	И предыдущий сценарий выполнен успешно
* Внес средства на лицевой счет
	...
	И в поле с именем 'ПолеВидыОплатВводСуммыСтрока_0' я ввожу текст "111"
	И я нажимаю на кнопку с именем 'КнопкаВидыОплатаНаименованиеСтрока_0'
	И я нажимаю на кнопку с именем 'Оплатить'
		
* Проверка МА
	Дано Я открываю навигационную ссылку "e1cib/list/РегистрНакопления.БонусныеСчета"
	И таблица 'Список' содержит строки по шаблону:
		| 'Период' | 'Регистратор'                            | 'Номер строки' | 'Бонусный счет'                            | 'Документ начисления'                    | 'Сумма'  | 'Содержание' |
		| '*'      | 'Взнос на лицевой счет наличными в *, *' | '1'            | '*, Бонус$$СлучайноеЧисло$$ , $$Клиент$$ ' | 'Взнос на лицевой счет наличными в *, *' | '22,420' | ''           |

Сценарий: Создание МА условие - Бонус рефералу (промокод)
	Дано Я открываю навигационную ссылку "$$МА_УсловияПрименения$$"
	И в поле с именем 'Наименование' я ввожу текст "Условие - Бонус рефералу (промокод); Способ - Процент 21,21% $$СлучайноеЧисло$$"
...
Сценарий: Проверка МА условие - Бонус рефералу (промокод)
	И предыдущий сценарий выполнен успешно
	И В командном интерфейсе я выбираю "Продажи" "Продажи"
	И я нажимаю на кнопку с именем 'Создать'
	И в поле с именем 'Контрагент' я ввожу текст "$$Клиент$$"
	...
	И элемент формы с именем 'Дек_МаркетинговыеАкции' стал равен "Маркетинговые акции (1 из 1)"
	И я нажимаю на кнопку с именем '_МаркетинговыеАкции'
	И элемент формы с именем 'НачисленоБонусовИтогСумма' стал равен "106,05"
	И у элемента формы с именем 'НачисленоБонусовИтогСумма' текст редактирования стал равен "106,05"

Сценарий: Создание МА условие - Остаток на лицевом счете
	Дано Я открываю навигационную ссылку "$$МА_УсловияПрименения$$"
	И в поле с именем 'Наименование' я ввожу текст "Условие - Остаток на лицевом счете; Способ - Процент 22,22% $$СлучайноеЧисло$$"
	И из выпадающего списка с именем 'УсловиеПредоставленияСкидки' я выбираю точное значение "Остаток на лицевом счете"
	И в поле с именем 'ВидЛицевогоСчета' я ввожу текст "Основной"
	И из выпадающего списка с именем 'ВидЛицевогоСчета' я выбираю точное значение "Основной (000000001)"
	И в поле с именем 'ЗначениеСкидкиНаценки' я ввожу текст "22,22"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранить'

Сценарий: Проверка МА условие - Остаток на лицевом счете
	И предыдущий сценарий выполнен успешно
	И Я проверяю маркетинговую акции
	И элемент формы с именем 'НачисленоБонусовИтогСумма' стал равен "111,10"
	И у элемента формы с именем 'НачисленоБонусовИтогСумма' текст редактирования стал равен "111,10"
...
Сценарий: Создание МА условие - Оплата суммовым пакетом
	Дано Я открываю навигационную ссылку "$$МА_УсловияПрименения$$"
	И в поле с именем 'Наименование' я ввожу текст "Условие - Оплата суммовым пакетом; Способ - Процент 23,23% $$СлучайноеЧисло$$"
	И из выпадающего списка с именем 'УсловиеПредоставленияСкидки' я выбираю точное значение "Оплата суммовым пакетом"
	И в поле с именем 'ЗначениеСкидкиНаценки' я ввожу текст "23,23"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранить'
...
* Сделал визит клиенту
	...
	И из выпадающего списка с именем 'ПолеФормы_Номенклатура_ТЧ_Запасы_0' я выбираю по строке "$$Услуга$$"
	И я нажимаю на кнопку с именем '_МаркетинговыеАкции'
	И элемент формы с именем 'НачисленоБонусовИтогСумма' стал равен "58,08"
	И у элемента формы с именем 'НачисленоБонусовИтогСумма' текст редактирования стал равен "58,08"
